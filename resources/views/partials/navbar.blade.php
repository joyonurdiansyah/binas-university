                    ...
                    <div
                        ...
                        <div class="pt-12">
                            <ul class="p-3 pl-8 list-disc bg-white text-nowrap rounded-xl">
                                ...
                                <li><a href="{{ route('visinisi') }}" class="block w-full py-1 pl-2 pr-8">Visi & Misi</a></li>
                                <li><a href="{{ route('sambutan') }}" class="block w-full py-1 pl-2 pr-8">Sambutan Rektor</a></li>
                                <li><a href="{{ route('fasilitas') }}" class="block w-full py-1 pl-2 pr-8">Fasilitas</a></li>
                            </ul>
                        </div>
                    </div>
                </li>
                    ...
                    <div class="hidden x-dropdown-menu" id="menu1">
                        <div>
                            <ul class="px-3 bg-white text-nowrap rounded-xl">
                                <li><a href="{{ route('sejarah') }}" class="block w-full py-1 pl-2 pr-8">Sejarah</a></li>
                                <li><a href="{{ route('Visimisi') }}" class="block w-full py-1 pl-2 pr-8">Visi & Misi</a></li>
                                <li><a href="{{ route('sambutan') }}" class="block w-full py-1 pl-2 pr-8">Sambutan Rektor</a></li>
                                <li><a href="{{ route('fasilitas') }}" class="block w-full py-1 pl-2 pr-8">Fasilitas</a></li>
                            </ul>
                        </div>
